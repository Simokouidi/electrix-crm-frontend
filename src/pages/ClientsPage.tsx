...
export default function ClientsPage(){
  ...
  React.useEffect(() => {
    ...
    sendUsage('clients_page_open', { path: (typeof location !== 'undefined' ? location.pathname : '') }).catch(()=>{})
    function flush(reason: string){
      ...
      sendUsage('clients_page_time', { reason, path: (typeof location !== 'undefined' ? location.pathname : '') }, sec)
    }
