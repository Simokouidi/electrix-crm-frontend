...
export default function LoginPage(){
  ...
  useEffect(() => {
    ...
    sendUsage('login_page_open', { path: (typeof location !== 'undefined' ? location.pathname : '') }).catch(()=>{})
    function flush(reason: string){
      ...
      sendUsage('login_page_time', { reason, path: (typeof location !== 'undefined' ? location.pathname : '') }, sec)
    }
  ...
  async function submit(e?: React.FormEvent){
    ...
    try{
      ...
      if(ok){
        ...
        sendUsage('login_success', { username: username || '' }).catch(()=>{})
        nav('/dashboard')
      } else {
